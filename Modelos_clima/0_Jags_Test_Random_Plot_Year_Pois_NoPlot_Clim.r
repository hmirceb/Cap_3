...
#monitor#  obs.error.sd, mn.log.lam, annuallamest, pcp_coefficient, tmax_coefficient

#data#  Ndups, dupvars, logN,goodendrows,Ngoodendrows,allcases, lags, Year, NYears, pcp, tmax
