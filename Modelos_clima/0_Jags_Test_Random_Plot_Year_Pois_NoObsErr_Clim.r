...
#monitor#  mn.log.lam, plot.sd, annuallamest, pcp_coefficient, tmax_coefficient

#data#  logN, goodendrows, Ngoodendrows, allcases, lags, Plot_unif, Year, NYears, NPlots, pcp, tmax
