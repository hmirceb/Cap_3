...
#monitor#  mn.log.lam, process.loglam.sd, obs.error.sd, annuallamest, pcp_coefficient, tmax_coefficient, tmin_coefficient

#data#  Ndups, dupvars, logN, goodendrows, Ngoodendrows, allcases, lags, Year, NYears, pcp, pcp_all, tmax, tmax_all, tmin, tmin_all
