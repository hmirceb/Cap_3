...
#monitor#  mn.log.lam, process.loglam.sd, plot.sd, annuallamest, pcp_coefficient, tmax_coefficient, tmin_coefficient

#data#  logN, goodendrows, Ngoodendrows, allcases, lags, Plot_unif, Year, NYears, NPlots, pcp, pcp_all, tmax, tmax_all, tmin, tmin_all
