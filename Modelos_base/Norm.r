...
#monitor#  mn.log.lam, process.loglam.sd, obs.error.sd, plot.sd, annuallamest

#data#  Ndups, dupvars, logN,goodendrows,Ngoodendrows,allcases, lags, Plot_unif, Year, NYears, NPlots
